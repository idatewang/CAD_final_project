...
set arrow 2 from 10,61 to 10,73 nohead lc rgb "red" lw 1.5 back
set arrow 3 from 15,9 to 15,16 nohead lc rgb "orange" lw 1.5 back
set arrow 4 from 57,61 to 57,61 nohead lc rgb "yellow" lw 1.5 back
set arrow 5 from 57,61 to 74,61 nohead lc rgb "yellow" lw 1.5 back
set arrow 6 from 15,61 to 15,61 nohead lc rgb "green" lw 1.5 back
set arrow 7 from 15,61 to 15,61 nohead lc rgb "green" lw 1.5 back
set arrow 8 from 62,9 to 62,9 nohead lc rgb "blue" lw 1.5 back
set arrow 9 from 34,4 to 41,4 nohead lc rgb "red" lw 1.5 back
set arrow 10 from 50,97 to 50,97 nohead lc rgb "orange" lw 1.5 back
set arrow 11 from 34,35 to 34,35 nohead lc rgb "yellow" lw 1.5 back
set arrow 12 from 34,35 to 34,42 nohead lc rgb "yellow" lw 1.5 back
set arrow 13 from 26,35 to 34,35 nohead lc rgb "yellow" lw 1.5 back
set arrow 14 from 34,42 to 50,42 nohead lc rgb "yellow" lw 1.5 back
set arrow 15 from 50,34 to 50,42 nohead lc rgb "yellow" lw 1.5 back
set arrow 16 from 50,34 to 88,34 nohead lc rgb "yellow" lw 1.5 back
set arrow 17 from 51,58 to 84,58 nohead lc rgb "orange" lw 1.5 back
set arrow 18 from 84,52 to 84,58 nohead lc rgb "orange" lw 1.5 back
set arrow 19 from 84,58 to 95,58 nohead lc rgb "orange" lw 1.5 back
set arrow 20 from 51,81 to 51,81 nohead lc rgb "yellow" lw 1.5 back
set arrow 21 from 28,81 to 51,81 nohead lc rgb "yellow" lw 1.5 back
set arrow 22 from 28,80 to 28,81 nohead lc rgb "yellow" lw 1.5 back
set arrow 23 from 14,80 to 28,80 nohead lc rgb "yellow" lw 1.5 back
set arrow 24 from 14,80 to 14,80 nohead lc rgb "yellow" lw 1.5 back
set arrow 25 from 8,29 to 8,37 nohead lc rgb "red" lw 1.5 back
set arrow 26 from 21,79 to 21,79 nohead lc rgb "orange" lw 1.5 back
set arrow 27 from 21,79 to 55,79 nohead lc rgb "orange" lw 1.5 back
set arrow 28 from 55,79 to 55,89 nohead lc rgb "orange" lw 1.5 back
set arrow 29 from 55,79 to 80,79 nohead lc rgb "orange" lw 1.5 back
set arrow 30 from 80,60 to 80,79 nohead lc rgb "orange" lw 1.5 back
set arrow 31 from 80,60 to 94,60 nohead lc rgb "orange" lw 1.5 back
set arrow 32 from 21,29 to 21,29 nohead lc rgb "yellow" lw 1.5 back
